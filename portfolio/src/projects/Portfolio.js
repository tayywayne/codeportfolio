    ...
    return (
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            ...
            <div className="relative h-64 overflow-hidden sm:h-80 lg:h-full">
                <img
                alt="Party"
                src="https://i.imgur.com/hkDbb3q.png"
            ...
            <div className="lg:py-16">
                ...
                <div className="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-8">
                    <div className=" text-center"><a href='https://taywayne.dev/' rel="noreferrer noopener" target="_blank">Live Site</a></div>

                    <div className="text-center"><a href='https://github.com/tayywayne/codeportfolio' rel="noreferrer noopener" target="_blank">Repo</a></div>
                </div>
                ...
                <div className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
                    ...
                    <div className="h-32 text-center">
                        <h3>Technologies</h3>
                        <p>React / Tailwind / HTML / CSS / Netlify</p>
                    </div>
